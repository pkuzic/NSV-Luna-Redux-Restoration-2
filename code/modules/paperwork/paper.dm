...
/obj/item/weapon/paper/verb/rename()
	...
	if((CLUMSY in usr.mutations) && prob(50))
		...
		return
	var/n_name = copytext_char(sanitize(input(usr, "What would you like to label the paper?", "Paper Labelling", null)  as text), 1, MAX_NAME_LEN)
...
/obj/item/weapon/paper/proc/burnpaper(obj/item/weapon/flame/lighter/P, mob/user)
...
/obj/item/weapon/paper/attackby(obj/item/weapon/P as obj, mob/user as mob)
	...
	else if(istype(P, /obj/item/weapon/flame/lighter))
		burnpaper(P, user)
...
/obj/item/weapon/paper/captain_william
	name = "paper - 'Page from a diary'"
	info = "<B>Дневник Уиль&#1103;ма Уилкерсона, страница 284.</B><BR><i>Капитан Уиль&#1103;м Уилкерсон, 21 &#1103;нвар&#1103; 12 часов 03 минуты.</i><BR><BR>Я остро чувствую падение уровн&#1103; кислорода, времени у мен&#1103; мало. Голова уже начинает кружитьс&#1103;. Дженкинс только что написал мне, что пытаетс&#1103; пробратьс&#1103; к аварийному ма&#1103;чку. Тварь перестала битьс&#1103; в шлюз, что радует. Вр&#1103;д-ли она могла причинить ему вред, но это здорово раздаражало. Будем молитьс&#1103;, что сектор не пуст, и нас подберут, пока не кончитс&#1103; кисло *<i>далее почерк становитс&#1103; слишком неразбочивым последнее слово обрываетс&#1103; на середине</i>*<HR><BR><i>Капитан Уиль&#1103;м Уилкерсон, 22 &#1103;нвар&#1103; 23 часа 15 минуты</i><BR><BR>Я заснул. Потер&#1103;л сознание. Дженкинс не выходит на св&#1103;зь. Я осталс&#1103; один. Дышать очень трудно, с каждым вдохом становитс&#1103; все хуже. Я задыхаюсь. Оно р&#1103;дом. Не ломитс&#1103;, но скребетс&#1103; в шлюз. Мне кажетс&#1103;, из под него сочитс&#1103; кровь. Это возможно?<HR><BR>Я перестаю чувствовать врем&#1103;. Трудно различить, когда &#1103; сплю, а когда нет.<HR><BR>Мне страшно<HR><BR>У мен&#1103; начались галюцинации. Я вижу Джинкинса и Мэри Энн. Они мертвы. Или нет? Очень трудно вспоминать.<HR><BR>В ЭТОЙ КАЮТЕ УЖАСНО ДУШНО душно ДУШНО. Я дышу, если не дышать во все легкие засыпаешь. Оно скребетс&#1103; СКРЕБЕТСЯ СКРЕБЕТСЯ!<HR><BR>*<i>почти нечитаемые каракули, рисунки</i>*<HR><BR>*<i>почерк удивительно четкий, твердый</i>* Джинкинс сказал что бы &#1103; не выходил, они готов&#1103;т мне сюрприз. Я и забыл, что у мен&#1103; день рождени&#1103;. Оказываетс&#1103;, у мен&#1103; был автоинъектор с инпровалином, &#1103; его вколол. Должно быть, &#1103; немного болен, нужно будет зайти к Доку. Л&#1103;гу поспать, надеюсь, они мен&#1103; добуд&#1103;тс&#1103;.<HR><BR><font size = '4'><b>СКРЕБЁТСЯ</b></font>"

/obj/item/weapon/paper/satellite

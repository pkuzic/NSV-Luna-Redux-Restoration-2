...
/client/proc/strike_team()
	...
	var/input = null
	while(!input)
		input = copytext_char(sanitize(input(src, "Please specify which mission the death commando squad shall undertake.", "Specify Mission", "")),1,MAX_MESSAGE_LEN)
		if(!input)
...
/mob/living/carbon/human/proc/equip_death_commando(leader_selected = 0)
	...
	equip_to_slot_or_del(new /obj/item/ammo_magazine/box/a357(src), slot_in_backpack)
